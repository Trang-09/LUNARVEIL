        ...
        <div class="containerlogin-group1">
          ...
          <div>
            ...
            <input name="fullName" type="text"
              style="padding-left: 6px;width:320px; height:36px;  border-style: outset;margin-bottom: 12px; border: 1px solid #11676a; border-radius: 8px;margin-right: 16px;"
          ...
          <div>
            ...
            <input id="email" name="email" type="email"
              style="padding-left: 6px;width:320px; height:36px; border-style: outset;margin-bottom: 12px; border: 1px solid #11676a; border-radius: 8px;"
              placeholder="Email">
          </div>
          <div>
            <div style="display: flex; flex-direction:row ;width: fit-content;">
          ...
          <div>
            ...
            <input id="repeatPassword" name="repeatPassword" type="password"
              style="padding-left: 6px;width:320px; height:36px; border-style: outset; border: 1px solid #11676a; border-radius: 8px;margin-bottom: 20px;"
          ...
          <div>
            ...
            <select id="city" name="tinh"
              style="width:332px; height:36px; border-style: outset;margin-bottom: 12px; border: 1px solid #11676a; border-radius: 8px;">
          ...
          <div>
            ...
            <input name="diaChiNha" type="text"
              style="padding-left: 6px;width:332px; height:36px; border-style: outset;margin-bottom: 34px; border: 1px solid #11676a; border-radius: 8px;"
