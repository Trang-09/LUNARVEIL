        ...
        <form name="frm" id="" action="modules/change_user_information_processing.php" method="POST" onsubmit="return kiemTra();" style="display: flex;flex-direction: row;width: 100%;">
          ...
          <div id="edit_infor_user">
            <div>
              ...
              <input class="LabelMedium" name="fullName" type="text" style="padding-left: 6px;width:320px; height:36px;  border-style: outset;margin-bottom: 12px; border: 1px solid #11676a; border-radius: 8px;" value="<?php echo $_SESSION['current_fullName'] ?>">
            </div>
            <div>
              ...
              <input class="LabelMedium" id="email" name="email" type="email" style="padding-left: 6px;width:320px; height:36px; border-style: outset;margin-bottom: 12px; border: 1px solid #11676a; border-radius: 8px;" value="<?php echo $_SESSION['current_email'] ?>">
            </div>
            <div>
              <div style="display: flex; flex-direction:row ;width: fit-content;">
              ...
              <input class="LabelMedium" id="numberPhone" name="numberPhone" type="text" style="padding-left: 6px;width:320px; height:36px; border-style: outset;margin-bottom: 12px; border: 1px solid #11676a; border-radius: 8px;" value="<?php echo $_SESSION['current_numberPhone'] ?>">
            </div>
          </div>
          <div id="edit_address_user">
            <div>
              <p class="LabelMedium" style="margin-top: 30px;margin-bottom: 4px;">Tỉnh/Thành phố (*)</p>
              <select class="LabelMedium" id="city" name="tinh" style="width:332px; height:36px; border-style: outset;margin-bottom: 12px; border: 1px solid #11676a; border-radius: 8px;">
            ...
            <div>
              ...
              <select class="LabelMedium" id="district" name="quanHuyen" style="width:332px; height:36px; border-style: outset;margin-bottom: 12px; border: 1px solid #11676a; border-radius: 8px;">
            ...
            <div>
              ...
              <select class="LabelMedium" id="ward" name="phuongXa" style="width:332px; height:36px; border-style: outset;margin-bottom: 12px; border: 1px solid #11676a; border-radius: 8px;">
            ...
            <div>
              ...
              <input class="LabelMedium" name="diaChiNha" type="text" style="padding-left: 6px;width:332px; height:36px; border-style: outset;margin-bottom: 34px; border: 1px solid #11676a; border-radius: 8px;" value="<?php echo $_SESSION['current_houseRoadAddress'] ?>">
            </div>
            <div style="width: 332px; display:flex;justify-content: center; padding: 0px 24px;">
              <input type="submit" name="btnSubmitEdit" id="btnSubmitEdit" class="containerlogin-text06 LabelLarge" value="Lưu" style="padding: 0px 24px;border: 1px solid #11676a;">
              </span>
              <input type="button" id="btnQuayveUser" class="containerlogin-text06 LabelLarge" value="Hủy" style="margin-left: 20px;padding: 0px 24px;border: 1px solid image_log;" onclick="quayVeUser();">
              </span>
            </div>
          </div>
        </form>
