      ...
      if (isAdminLogged()) {
        ...
        echo '
          ...
          <div style="width:100%;display:flex;flex-direction:column;align-items:center;">
            ...
            style="width:70%; height:42px; border-style: outset; border: 1px solid #11676a; border-radius: 8px;"
          ...
          <div id="container-pass" style="display:flex;flex-direction:column;align-items:center;width:100%;">
            ...
            <div style="display:flex;flex-direction:column;align-items:center;width:70%;">
                ...
                style="width:100%; height:42px; border-style: outset; border: 1px solid #11676a; border-radius: 8px;"
