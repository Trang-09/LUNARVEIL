...
function reload_ItemTotal(productID, price, quantity){
    ...
    label.innerText = new Intl.NumberFormat('en-US').format(parseFloat(price) * quantity) + " $"; 
...
function reload_Total(){
    ...
    totalLabel[0].children[1].innerText = new Intl.NumberFormat('en-US').format(total) + " $";
}
