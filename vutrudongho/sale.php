...
<div class="revenue_content">
    ...
    <div class="revenue_right_content">
        <div class="revenue_card" style="background-image: linear-gradient(#11676a,#422393);">
            <h1>Doanh thu hôm nay</h1>
            <p><?php echo number_format($revenue) ?> USD</p>
        </div>
        ...
        <div class="revenue_card" style="background-image: linear-gradient(#4C9D62,#32964E);">
            ...
            <p><?php echo number_format($import) ?> USD</p>
        </div>
