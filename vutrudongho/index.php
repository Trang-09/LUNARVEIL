  ...
  <div id="main"
    ...
    <div style="background-color: #fff;">
      ...
      <div id="productKD" style="margin-top: 30px;margin-left: 50px;margin-right: 50px;">
        <div
          style="width: 200px;height:200px;background-color:#1cabb0;display: flex;justify-content: center;align-items: center;">
          <div id="pdIphone" style="display:flex ;flex-direction: column;position: relative;">
            <!-- <p onclick="window.location.href='#casioBrandInfo'" class="mediumtitlehome"
              style="cursor: pointer;color:#fff ;text-align: center;background-color: #1cabb0;position: absolute;width:100% ;top:50%;transform: translateY(-50%);line-height: 1.5;">
              Casio</p> -->
            <div
        ...
        <div
          style="width: 200px;height:2020x;background-color:#1cabb0;display: flex;justify-content: center;align-items: center;">
    ...
    <div id="casioBrandInfo" style="background-color: #1cabb0; margin-top: 56px; padding-bottom: 56px;">
