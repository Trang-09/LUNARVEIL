<?php
    ...
    // ===========================
    // XỬ LÝ ADD TO CART TỪ paging-brand.php / detail-product.php
    // ===========================
    ...
    if (isset($_GET['ProductID']) && isset($_GET['Quantity'])) {
        ...
        if ($conn = connectDatabase()) {
            ...
            $check = mysqli_query($conn, 
                "SELECT * FROM cart WHERE UserID='$userID' AND ProductID='$pID'"
            );
            ...
            if (mysqli_num_rows($check) > 0) {
                ...
                mysqli_query($conn,
                    ...
                    WHERE UserID='$userID' AND ProductID='$pID'"
                );
            } else {
                // Thêm mới
                mysqli_query($conn,
                    "INSERT INTO cart (UserID, ProductID, Quantity) 
                    VALUES ('$userID', '$pID', '$qty')"
                );
            }
        }

        // Sau khi thêm → xóa GET để tránh thêm 2 lần khi refresh
    ...
    <div class="cart">
        <div class="cart_body">
            ...
            <div class="cart_detail">
                ...
                ?>
                        <div class="cart_item">
                            ...
                            <div class="cart_item_unitprice" data-id="<?php echo $product["PriceToSell"] ?>"><?php echo number_format($product["PriceToSell"]) ?> $</div>
                            ...
                            <div class="cart_item_total" id="<?php echo $item["ProductID"] ?>" ><?php echo number_format(   $product["PriceToSell"]*$item["Quantity"]   ) ?> $</div>
            ...
            <div class="cart_totalprice">
                <p>Tổng cộng:</p>
                <p style="color: #11676a; font-size: 1.375rem;">$ 0</p>
            </div>
            <div class="button">
