                ...
                success: function(data) {
                    ...
                    $("#slider-range").slider({
                        ...
                        slide: function(event, ui) {
                            $("#amount").val("$" + addPlus(ui.values[0]).toString() + " - $" + addPlus(ui.values[1]));
...
$.ajax({
    ...
    success: function(data) {
        ...
        $("#slider-range-2").slider({
            ...
            values: [0, maxPrice],
            slide: function(event, ui) {
                $("#amount-2").val("$" + addPlus(ui.values[0]).toString() + " - $" + addPlus(ui.values[1]));
                $('.price_from').val(ui.values[0]);
                $('.price_to').val(ui.values[1]);
            }
        });
        $("#amount-2").val("$" + addPlus($("#slider-range-2").slider("values", 0)) +
            " - $" + addPlus($("#slider-range-2").slider("values", 1)));
    },
    error: function() {
        alert('Lỗi khi lấy dữ liệu');
    }
